...
const LandingContent = () => {
  return (
    <div className='pt-[10vh] sm:pb-0 h-[100vh] sm:flex-col sm:pt-[14vh] text-white badges'>
      ...
      <div className='sm:pb-[20vh] flex sm:flex-col'>
        <div className='px-[8vw] flex flex-col w-[80vw] sm:w-[90vw] pt-[8vh] sm:pt-[0] sm:pb-8 z-0 justify-center'>
